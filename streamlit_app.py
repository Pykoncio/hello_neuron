...
st.image("img/neurona.jpg", use_container_width=True)
...
with tab1:
    ...
    w0 = st.slider("s0", min_value=0.00, max_value=5.00, value=0.5, step=0.01)
...
with tab2:
    ...
    with col1:
        ...
        w0 = st.slider("s1", min_value=0.00, max_value=5.00, value=0.5, step=0.01)
        st.markdown("Input x<sub>0</sub>", unsafe_allow_html=True)
        x0 = st.number_input("n0", value=0.00, step=0.01)

    with col2:
        st.markdown("Weight w<sub>1</sub>", unsafe_allow_html=True)
        w1 = st.slider("s2", min_value=0.00, max_value=5.00, value=0.5, step=0.01)
        st.markdown("Input x<sub>1</sub>", unsafe_allow_html=True)
        x1 = st.number_input("n1", value=0.00, step=0.01)
...
with tab3:
    ...
    with col1:
        st.markdown("Weight w<sub>0</sub>", unsafe_allow_html=True)
        w0 = st.slider("s3", min_value=0.00, max_value=5.00, value=0.5, step=0.01)
        st.markdown("Input x<sub>0</sub>", unsafe_allow_html=True)
        x0 = st.number_input("n2", value=0.00, step=0.01)

    with col2:
        st.markdown("Weight w<sub>1</sub>", unsafe_allow_html=True)
        w1 = st.slider("s4", min_value=0.00, max_value=5.00, value=0.5, step=0.01)
        st.markdown("Input x<sub>1</sub>", unsafe_allow_html=True)
        x1 = st.number_input("n3", value=0.00, step=0.01)

    with col3:
        st.markdown("Weight w<sub>2</sub>", unsafe_allow_html=True)
        w2 = st.slider("s5", min_value=0.00, max_value=5.00, value=0.5, step=0.01)
        st.markdown("Input x<sub>2</sub>", unsafe_allow_html=True)
        x2 = st.number_input("n4", value=0.00, step=0.01)
