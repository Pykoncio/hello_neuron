...
with tab1:
    ...
    w0 = st.slider("Weight", min_value=0.00, max_value=5.00, value=0.5, step=0.01)
...
with tab2:
    ...
    with col1:
        ...
        x0 = st.number_input("s2", value=0.00, step=0.01)

    with col2:
        st.markdown("Weight w<sub>1</sub>", unsafe_allow_html=True)
        w1 = st.slider("s1", min_value=0.00, max_value=5.00, value=0.5, step=0.01)
        st.markdown("Input x<sub>1</sub>", unsafe_allow_html=True)
        x1 = st.number_input("s2", value=0.00, step=0.01)
...
with tab3:
    ...
    with col3:
        ...
        w2 = st.slider("s1", min_value=0.00, max_value=5.00, value=0.5, step=0.01)
        st.markdown("Input x<sub>2</sub>", unsafe_allow_html=True)
        x2 = st.number_input("s2", value=0.00, step=0.01)
